...
export default function AboutPage() {
  return (
    <article className="max-w-2xl mx-auto space-y-6 text-sm leading-relaxed">
      <h1 className="text-3xl font-bold font-display">運営者情報</h1>
      <table className="w-full text-left border-collapse">
        <tbody>
          ...
          <tr className="border-b border-line">
            ...
            <td className="py-3">
              <a
                ...
                className="inline-flex min-h-[48px] items-center text-primary-text font-bold hover:underline"
              >
          ...
          <tr className="border-b border-line">
            ...
            <td className="py-3">
              <a href="mailto:contact@mainichi-lab.com" className="inline-flex min-h-[48px] items-center text-primary-text font-bold hover:underline break-all">
                contact@mainichi-lab.com
              </a>
              <span className="block text-sm text-sub mt-1">詳しくはお問い合わせページをご覧ください。</span>
              <Link href="/contact" className="inline-flex min-h-[48px] items-center text-sm text-primary-text hover:underline">
                → お問い合わせページ
              </Link>
            </td>
          </tr>
      ...
      <section className="space-y-2">
        <h2 className="text-2xl font-bold">当サイトについて</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-2xl font-bold">記事の編集方針</h2>
        <p>
        ...
        <p>
          ...
          誤りのご指摘はお問い合わせからいつでも受け付けており、確認のうえ記事を修正します。
        </p>
        <p>
          <Link href="/contact" className="inline-flex min-h-[48px] items-center text-primary-text font-bold hover:underline">→ お問い合わせ</Link>
        </p>
      </section>
      <section className="space-y-2">
        <h2 className="text-2xl font-bold">広告について</h2>
        <p>
          当サイトは、第三者配信の広告およびアフィリエイトプログラムを利用しています。
          広告リンクを含む箇所には「PR」と明示しています。詳細はプライバシーポリシーをご確認ください。
        </p>
        <p>
          <Link href="/privacy" className="inline-flex min-h-[48px] items-center text-primary-text font-bold hover:underline">→ プライバシーポリシー</Link>
        </p>
      </section>
      <p>
