...
function ShindanIntro() {
  return (
    <ToolIntro
      heading="方言タイプ診断について"
      paragraphs={[
        "この診断は、ふだんの言い回しと性格の好みを全14問たずねて、あなたの言葉がどの方言圏のタイプに近いかを出す無料ツールです。出身地は聞きません。手がかりにするのは「気を抜いたときに出る言い方」だけです。",
      ...
      facts={[
        {
          h: "何を判定しているのか",
          body: [
            "判定しているのは出身地ではなく、言葉の好みです。材料は2つだけで、8問で選んだ方言フレーズと、6問の性格の答えです。",
            "出題に使うフレーズは、このサイトが持っている36の言い方（標準語を含む）ぶん・432件の方言フレーズから選ばれます。言葉づかいの質問は12種、性格の質問も12種あり、診断のたびにそこから8問と6問がランダムに選び直されます。",
      ...
      faq={[
        ...
        },
        {
          ...
          a: "できます。標準語の選択肢は0点なので、6問の性格の答えと、「あえて選ぶならこっち」と思った言い方だけで判定します。標準語が続くと出題は全国の言い方に広がります。",
        },
        {
          q: "何度やっても同じ結果になりますか？",
          a: "なりません。毎回12種の中から8問と6問が選び直されるので、出題そのものが変わります。答えが少し違えば成分の比率も変わります。",
        },
        {
          q: "答えた内容はどこに保存されますか？",
