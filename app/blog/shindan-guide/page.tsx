...
export default function Page() {
  return (
    <ArticleShell article={article}>
      <P>
        方言ラボの方言タイプ診断
        は、10問の質問に答えるだけで、全国{TYPES.length}体のご当地キャラからあなたの相棒を判定するツールです。
      ...
      <H2>診断の流れ：10問・約2分</H2>
      <H3>ステップ1｜言葉づかいの質問（6問）</H3>
      <P>
        最初の6問では、日常の場面でどんな言い回しを選ぶかを聞かれます。
        「ここは自分ならこう言う」に近いものを選んでください。方言を知らなくても大丈夫で、
        <strong>語感の好みで選んで問題ありません</strong>。この6問で、あなたの言葉の距離感が全国のどの方言に近いかを測ります。
      </P>
      <H3>ステップ2｜性格の質問（4問）</H3>
      <P>
        続く4問は、行動や価値観についての質問です。ここで判定されるのが後述の「気質タイプ」で、
        同じ方言キャラが出た人どうしでも、この4問の答えによって結果の文面が変わります。
      </P>
      <H3>ステップ3｜結果とキャラ判定</H3>
      <P>
        10問すべてに答えると、あなたの方言キャラが表示されます。質問は毎回プールからランダムに選ばれるため、
      ...
      <H3>② 気質タイプ（7種）</H3>
      <P>
        性格4問から判定される、あなたの内面のタイプです。全部で{CLUSTERS.length}種類あります。
      </P>
      ...
      <ShindanCta
        title="まずは1回、やってみる"
        body="10問・約2分。登録不要・無料です。出たキャラのコードを控えておけば、友達との相性チェックにそのまま使えます。"
      />
    </ArticleShell>
  );
}
